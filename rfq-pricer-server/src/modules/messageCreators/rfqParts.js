...
import { getTenors } from '../common/tenors';
...
export const getProductType = (excluded = []) => _.sample(_.difference([products.FWD, products.SPOT], excluded));
...
export const getTenor = (excluded = []) => _.sample(_.difference(getTenors(), excluded));
